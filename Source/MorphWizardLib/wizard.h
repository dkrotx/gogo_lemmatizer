...
public:
	...
	void	predict_lemm(const string &lemm, int minimal_frequence, bool bOnlyMainPartOfSpeeches);
	...
	CParadigmInfo	add_lemma(const string &slf, string common_grammems, const string& prefixes, int& line_no_err); 
